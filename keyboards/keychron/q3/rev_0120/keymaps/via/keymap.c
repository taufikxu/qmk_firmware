...
qk_tap_dance_action_t tap_dance_actions[32] = {
...
const uint16_t PROGMEM keymaps[25][MATRIX_ROWS][MATRIX_COLS] = {

    [MAC_BASE] = LAYOUT_ansi_87(
        KC_ESC,             KC_F1,  KC_ENT,  KC_MCTL,  KC_LPAD,  G(KC_R),    G(KC_D),    C(KC_LEFT),    C(KC_RGHT),  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_PSCR,  KC_SLCK,  KC_PAUS,
        ...
        KC_LCTL,  KC_LOPT, TD(MAC_TD_LCMD),                               KC_SPC,                                 TD(MAC_TD_RCMD), KC_RCMD, MO(NumberSwitchLayer), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [MAC_FN_MAIN] = LAYOUT_ansi_87(
        LCMD(KC_Q),            KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10,  KC_F11,   KC_F12,  KC_NO,  KC_NO,  KC_NO,
        ...
        KC_LCTL,  KC_LCMD,  MO(MAC_FN_MAIN),                                LCMD(KC_SPC),                                KC_NO,  KC_NO,  MO(NumberSwitchLayer), KC_RSFT, KC_NO,  KC_NO,  KC_NO),

    [MAC_FN_CAPLOCK]=LAYOUT_ansi_87(
        LCMD(KC_ESC),LCMD(KC_F1),LCMD(KC_F2),LCMD(KC_F3),LCMD(KC_F4),LCMD(KC_F5),LCMD(KC_F6),LCMD(KC_F7),LCMD(KC_F8),LCMD(KC_F9),LCMD(KC_F10),LCMD(KC_F11),LCMD(KC_F12),LCMD(KC_PSCR),LCMD(KC_SLCK),LCMD(KC_PAUS),
        ...
        KC_LCTL,KC_LOPT,KC_LCMD,LCMD(KC_SPC),KC_RCMD,KC_ROPT,MO(NumberSwitchLayer),KC_RCTL,LCMD(KC_LEFT),LCMD(KC_DOWN),LCMD(KC_RGHT)),

    [WIN_BASE] = LAYOUT_ansi_87(
        KC_ESC,             KC_F1,KC_F2,C(A(KC_TAB)),KC_LWIN,C(KC_R),G(KC_D),C(G(KC_LEFT)),C(G(KC_RGHT)),   KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU, KC_PSCR, KC_SLCK,  KC_PAUS,
        KC_ESC_MOD,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,    KC_BSPC,  KC_INS,   KC_HOME,  KC_PGUP,
        ...
        KC_LCTL ,KC_LWIN, TD(WIN_TD_LALT),                                KC_SPC,                    TD(WIN_TD_RALT),  KC_RALT, MO(NumberSwitchLayer), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [WIN_FN_MAIN] = LAYOUT_ansi_87(
        LALT(KC_F4),            KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10,  KC_F11,   KC_F12,  KC_NO,  KC_NO,  KC_NO,
        ...
        KC_LCTL,  KC_LALT,  MO(WIN_FN_MAIN),                                A(KC_SPC),                                KC_NO,  KC_NO,  MO(NumberSwitchLayer), KC_RSFT, KC_NO,  KC_NO,  KC_NO),

    [WIN_FN_CAPLOCK]=LAYOUT_ansi_87(
        LCTL(KC_ESC),LCTL(KC_F1),LCTL(KC_F2),LCTL(KC_F3),LCTL(KC_F4),LCTL(KC_F5),LCTL(KC_F6),LCTL(KC_F7),LCTL(KC_F8),LCTL(KC_F9),LCTL(KC_F10),LCTL(KC_F11),LCTL(KC_F12),LCTL(KC_PSCR),LCTL(KC_SLCK),LCTL(KC_PAUS),
        ...
        KC_LCTL,KC_LWIN,KC_LALT,LCTL(KC_SPC),KC_RALT,KC_RWIN,MO(NumberSwitchLayer),KC_RCTL,LCTL(KC_LEFT),LCTL(KC_DOWN),LCTL(KC_RGHT)),


    [BOTH_FN_SPEC_CHAR] = LAYOUT_ansi_87(
        ...
        KC_NO,            KC_NO,  KC_NO,  KC_SLSH,  LSFT(KC_8),  KC_NO,  LSFT(KC_EQL),  KC_MINUS,  KC_LEQ,  KC_GEQ,  KC_DIVEQL,  KC_NO,            KC_NO,
        KC_NO,  KC_NO,  KC_NO,                               KC_SPC,                                KC_NO,  KC_NO,  MO(NumberSwitchLayer), KC_NO, KC_NO,  KC_NO,  KC_NO),

    [GameLayer] = LAYOUT_ansi_87(
        KC_ESC,             KC_F1,   KC_F2,    KC_F3,    KC_F4,  KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   KC_PSCR,   KC_G,  KC_PAUS,
        ...
        KC_LCTL,  KC_LWIN, KC_LALT,                               KC_SPC,                                 KC_RALT, KC_RWIN,MO(NumberSwitchLayer), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    
    [NormalMac] = LAYOUT_ansi_87(
        KC_ESC,             KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LPAD,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,   KC_VOLU,  KC_PSCR,  KC_M,  KC_PAUS,
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,    KC_BSPC,  KC_INS,   KC_HOME,  KC_PGUP,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,   KC_BSLS,  KC_DEL,   KC_END,   KC_PGDN,
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,            KC_UP,
        KC_LCTL,  KC_LOPT, KC_LCMD,                               KC_SPC,                                 KC_RCMD, KC_ROPT,MO(NumberSwitchLayer), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [NormalWin] = LAYOUT_ansi_87(
        KC_ESC,             KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   KC_PSCR,  KC_W,  KC_PAUS,
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,    KC_BSPC,  KC_INS,   KC_HOME,  KC_PGUP,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,   KC_BSLS,  KC_DEL,   KC_END,   KC_PGDN,
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,            KC_UP,
        KC_LCTL,  KC_LCMD,  KC_LALT,                                KC_SPC,                                 KC_RALT,  KC_RWIN, MO(NumberSwitchLayer), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [NormalWin_ForMacUser] = LAYOUT_ansi_87(
        KC_ESC,             KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   KC_PSCR,  KC_W,  KC_PAUS,
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,    KC_BSPC,  KC_INS,   KC_HOME,  KC_PGUP,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,   KC_BSLS,  KC_DEL,   KC_END,   KC_PGDN,
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,            KC_UP,
        KC_LALT,  KC_LCMD,  KC_LCTL,                                KC_SPC,                                 KC_RALT,  KC_RWIN, MO(NumberSwitchLayer), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [NumberSwitchLayer] = LAYOUT_ansi_87(
        KC_NO,          KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO,  KC_NO,  KC_VOLD,    KC_VOLU,   KC_NO,  KC_NO,  RGB_TOG,
        KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_NO,  DF(MAC_BASE),  DF(GameLayer),  DF(NormalMac),
        ...
        KC_NO,  KC_NO,  KC_NO,                                KC_0,                                KC_NO,  KC_NO,   MO(NumberSwitchLayer),    MO(NumberSwitchLayer),  KC_NO,  KC_NO,  KC_NO),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    // [WIN_FN_LALT_TAP] = LAYOUT_ansi_87(
    //     KC_ESC,            KC_W,  KC_2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10,  KC_F11,   KC_F12,  KC_NO,  KC_NO,  KC_NO,
    //     KC_ESC,  KC_LCTL, KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_BSPC,      KC_NO,  KC_NO,  KC_NO,
    //     KC_TAB, KC_Q,      KC_HOME,    KC_UP,  KC_END, KC_PGUP,  KC_PGUP,  KC_HOME,  KC_UP,  KC_END,  KC_BSPC,  KC_DEL,  KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,
    //     KC_RCTL,   KC_LCTL,  KC_LEFT,  KC_DOWN,  KC_RIGHT,  KC_PGDN,  KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_NO,  KC_ENT,        KC_NO,
    //     KC_LSFT,            KC_BSPC,  LCTL(KC_LEFT),  KC_NO,   LCTL(KC_RIGHT), KC_DEL,   KC_BSPC,  KC_DEL,  KC_NO,  KC_NO,  KC_NO,  KC_NO,            KC_NO,
    //     KC_LCTL,  KC_LWIN,  KC_LALT,                                KC_NO,                                KC_NO,  KC_NO,  MO(NumberSwitchLayer), KC_NO, KC_NO,  KC_NO,  KC_NO),
