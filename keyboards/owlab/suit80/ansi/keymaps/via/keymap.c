...
const uint16_t PROGMEM keymaps[25][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi(
        KC_ESC,             KC_F1,  KC_ENT,  KC_MCTL,  KC_LPAD,  G(KC_R),    G(KC_D),    C(KC_LEFT),    C(KC_RGHT),  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU, DF(WIN_BASE), KC_PSCR,  KC_SLCK,  KC_PAUS,
        ...
        KC_LCTL,  KC_LOPT, TD(MAC_TD_LCMD),                               KC_SPC,                                 TD(MAC_TD_RCMD), KC_RCMD, MO(NumberSwitchLayer),  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN_MAIN] = LAYOUT_ansi(
        ...
        KC_LCTL,  KC_LCMD,  MO(MAC_FN_MAIN),                                LCMD(KC_SPC),                                KC_NO,  KC_NO,  MO(NumberSwitchLayer), KC_NO,  KC_NO,  KC_NO),
    ...
    [MAC_FN_CAPLOCK]=LAYOUT_ansi(
        ...
        KC_LCTL,KC_LOPT,KC_LCMD,LCMD(KC_SPC),KC_RCMD,KC_ROPT,MO(NumberSwitchLayer),LCMD(KC_LEFT),LCMD(KC_DOWN),LCMD(KC_RGHT)),

    [WIN_BASE] = LAYOUT_ansi(
        KC_ESC,             KC_F1,KC_F2,C(A(KC_TAB)),KC_LWIN,C(KC_R),G(KC_D),C(G(KC_LEFT)),C(G(KC_RGHT)),   KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU, KC_NO, KC_PSCR, KC_SLCK,  KC_PAUS,
        KC_ESC_MOD,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,    KC_BSPC,  KC_INS,   KC_HOME,  KC_PGUP,
        ...
        KC_LCTL ,KC_LWIN, TD(WIN_TD_LALT),                                KC_SPC,                    TD(WIN_TD_RALT),  KC_RALT, MO(NumberSwitchLayer),  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN_MAIN] = LAYOUT_ansi(
        ...
        KC_LCTL,  KC_LALT,  MO(WIN_FN_MAIN),                                A(KC_SPC),                                KC_NO,  KC_NO,  MO(NumberSwitchLayer), KC_NO,  KC_NO,  KC_NO),
    ...
    [WIN_FN_CAPLOCK]=LAYOUT_ansi(
        ...
        KC_LCTL,KC_LWIN,KC_LALT,LCTL(KC_SPC),KC_RALT,KC_RWIN,MO(NumberSwitchLayer),LCTL(KC_LEFT),LCTL(KC_DOWN),LCTL(KC_RGHT)),
    ...
    [BOTH_FN_SPEC_CHAR] = LAYOUT_ansi(
        ...
        KC_NO,  KC_NO,  KC_NO,                               KC_SPC,                                KC_NO,  KC_NO,  MO(NumberSwitchLayer), KC_NO,  KC_NO,  KC_NO),
    ...
    [GameLayer] = LAYOUT_ansi(
        ...
        KC_LCTL,  KC_LWIN, KC_LALT,                               KC_SPC,                                 KC_RALT, KC_RWIN,MO(NumberSwitchLayer),  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [NormalMac] = LAYOUT_ansi(
        ...
        KC_LCTL,  KC_LOPT, KC_LCMD,                               KC_SPC,                                 KC_RCMD, KC_ROPT,MO(NumberSwitchLayer),  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [NormalWin] = LAYOUT_ansi(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,            KC_UP,
        KC_LCTL,  KC_LCMD,  KC_LALT,                                KC_SPC,                                 KC_RALT,  KC_RWIN, MO(NumberSwitchLayer),  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [NormalWin_ForMacUser] = LAYOUT_ansi(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,            KC_UP,
        KC_LALT,  KC_LCMD,  KC_LCTL,                                KC_SPC,                                 KC_RALT,  KC_RWIN, MO(NumberSwitchLayer),  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [NumberSwitchLayer] = LAYOUT_ansi(
        ...
        KC_NO,  KC_NO,  KC_NO,                                KC_0,                                KC_NO,  KC_NO,   MO(NumberSwitchLayer),  KC_NO,  KC_NO,  KC_NO),
};
